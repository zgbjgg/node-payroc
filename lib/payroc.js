...
module.exports = function () {
  ...
  /* Function to execute step three */
  function step_three(tokenId, callback) {
    var params = [];
    ...
    // to xml
    var xmlRequest = js2xmlparser.parse("complete-action", params);
  ...
  return {
    ...
    step_three: function(apiKey, tokenId, callback) {
      step_three(apiKey, tokenId, callback)
    }
  } 
}
